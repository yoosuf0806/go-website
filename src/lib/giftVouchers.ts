...
// 'expired' covers a voucher outside its optional validity window (either not
// yet active, or past its deadline) — see validate_gift_voucher() in the
// voucher-validity-window migration.
export type VoucherStatus = 'ok' | 'invalid' | 'used' | 'expired'
